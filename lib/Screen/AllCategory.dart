...
class _AllCategoryState extends State<AllCategory> {
  ...
  getShopCategory() async {
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse(ApiServicves.getCategories));
    request.fields.addAll({
      'roll': '1'
    });
    request.headers.addAll(headers);
  ...
  getProduct() async {
    ...
    var request = http.MultipartRequest(
        'POST', Uri.parse(ApiServicves.getVendorProduct));
    request.fields.addAll({
                                                        ...
                                                        children: [
                                                          Container(
                                                              ...
                                                              decoration: BoxDecoration(borderRadius: BorderRadius.circular(10),
                                                                color: Colors.white,
                                                                image: DecorationImage(
                                                                  image: NetworkImage('${ApiServicves.imageUrl}${subCatData?.data?[index].image}'),
                                                                  fit: BoxFit.fill,
                                                                ),
                                                              ),
                                                          ),
                                  ...
                                  Center(
                                    child: Container(
                                      ...
                                      child: ElevatedButton(
                                        ...
                                        onPressed: () {
                                          Navigator.push(context, MaterialPageRoute(builder: (context) => Congratutation()));
                                        },
                                        child: const Text(
                                          'Buy',
                                          style: TextStyle(
