...
class _SignUpPersonalState extends State<SignUpPersonal> {
    ...
    if (response.statusCode == 200) {
      ...
      if (finaResult['response_code'] == '1') {
        ...
        await prefs.setString(
            'vendor_id', finaResult['data']['vendor_id'].toString());
        await prefs.setString(
            'vendor_name', finaResult['data']['username'].toString());
        await prefs.setString(
            'vendor_email', finaResult['data']['email'].toString());
  ...
  String? _validateUpi(value) {
    if (value!.isEmpty) {
      return "Please enter an UpiId";
    }
    RegExp emailRegExp = RegExp(r'^[\w-\.]+@([\w-]+\.)+[\w-]{2,4}$');
    if (!emailRegExp.hasMatch(value)) {
      return "Please enter a valid UpiId";
    }
  }
        ...
        builder: (context) => PlacePicker(
          ...
          onPlacePicked: (result) {
            ...
            setState(() {
              ...
              print("latitytautta $latitude $longitudes $myLoction");
            });
            Navigator.of(context).pop();
          },
          initialPosition: LatLng(double.parse(latitude ?? "0.0"),
              double.parse(longitudes ?? "0.0")),
                                  ...
                                  child: Container(
                                    ...
                                    child: TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                          hintText: _selectedOption3 == "shop"
                                              ? 'Shop Name'
                                              : 'Company Name',
                                          isDense: true,
                                          enabledBorder:
                                        ...
                                        if (!isPasswordValid)
                                          const Padding(
                                            padding: EdgeInsets.symmetric(
                                                horizontal: 8.0),
                                            child: Text(
                                              'Max limit should be 15 characters',
                                              style:
                                      ...
                                      child: DropdownButton(
                                        ...
                                        onChanged: (CityData? value) {
                                          setState(() {
                                            ...
                                            // stateName = stateValue!.name;
                                            print(
                                                "name herererb $cityValue $cityId");
                                          });
                                        },
                                        underline: Container(),
                                      ),
