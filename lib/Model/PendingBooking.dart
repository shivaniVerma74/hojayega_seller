...
class PendingBookingModel {
  ...
  PendingBookingModel.fromJson(dynamic json) {
  ...
  String? _msg;
  List<Data>? _data;
PendingBookingModel copyWith({  String? responseCode,
  String? msg,
  List<Data>? data,
}) => PendingBookingModel(  responseCode: responseCode ?? _responseCode,
  msg: msg ?? _msg,
  data: data ?? _data,
);
